...
class TestPlotParameterEvolution(unittest.TestCase):
    ...
    def test_plot_parameter_evolution_basic(self, mock_plt):
    ...
    @patch('timeref.reports.plotting.plt')
    def test_plot_parameter_evolution_with_output(self, mock_plt):
    ...
    @patch('timeref.reports.plotting.plt')
    def test_plot_parameter_evolution_basic_functionality(self, mock_plt):
    ...
    @patch('timeref.reports.plotting.plt')
    def test_plot_parameter_evolution_custom_parameters(self, mock_plt):
...
class TestPlotReflectivityEvolution(unittest.TestCase):
    ...
    def test_plot_reflectivity_evolution_custom_params(self, mock_plot_sld, mock_plt):
        ...
        mock_plt.xlim.assert_called_with((0.01, 0.15))
