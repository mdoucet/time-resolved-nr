...
from timeref.model_utils import (
    sample_from_json,
    expt_from_json_file,
...
class TestSampleFromJson:
    ...
    def test_sample_from_json_prior_scale_zero(
        ...
        result = sample_from_json(
            sample_model_expt_json, model_err_json=sample_model_err_json, prior_scale=0
        )
...
class TestExptFromJsonFile:
    ...
    def test_expt_from_json_file_with_probe(
        ...
        mock_experiment_class.assert_called_once_with(
            probe=mock_probe, sample=mock_original_experiment.sample
        )
...
class TestCalculateReflectivity:
    ...
    def test_calculate_reflectivity_basic(self, mock_expt_from_json):
        ...
        mock_expt_from_json.assert_called_once_with(
            "test_model.json", q_values, q_resolution=0.025
        )
    ...
    def test_calculate_reflectivity_custom_resolution(self, mock_expt_from_json):
        ...
        result = calculate_reflectivity(
            "test_model.json", q_values, q_resolution=custom_resolution
        )
